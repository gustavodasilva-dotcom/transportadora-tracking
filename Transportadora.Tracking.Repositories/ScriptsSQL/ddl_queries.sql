...
(1, 'Recepcionado', 1, GETDATE()),
(2, 'Em trânsito', 1, GETDATE()),
(3, 'Entregue', 1, GETDATE()),
(4, 'CEP inválido', 1, GETDATE()),
(6, 'Roubado', 1, GETDATE()),
(5, 'Extraviado', 1, GETDATE());

DROP TABLE IF EXISTS OCORRENCIA_PEDIDO
